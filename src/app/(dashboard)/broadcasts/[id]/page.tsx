        ...
        {steps.map((step) => {
          ...
          return (
            <div key={step.label} className="flex items-center gap-3">
              ...
              <div className="relative h-7 flex-1 rounded-full bg-secondary">
                <div
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <div className="flex items-center gap-3">
              <h1 className="page-title">{broadcast.name}</h1>
              <span
        ...
        {confirmDelete ? (
          <div className="flex items-center gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-1.5 text-sm">
            ...
            <Button
              ...
              disabled={deleting}
              className="h-7 border-border bg-transparent text-foreground hover:bg-secondary"
            >
              Cancel
            </Button>
            <Button

...
import { GitBranch, Plus, ChevronDown, Settings } from "@/components/ui/icons";
    ...
    return (
      <div className="page-shell">
        ...
        <div className="flex gap-3">
          {[1, 2, 3, 4, 5].map((i) => (
            <div key={i} className="h-96 w-72 animate-pulse rounded-xl bg-secondary" />
          ))}
        </div>
      </div>
    );
    ...
    <div className="page-shell">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        <div className="flex items-center gap-3">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger
              className="inline-flex items-center gap-2 rounded-lg border border-border bg-card px-3 py-2 text-sm text-foreground hover:bg-secondary transition-colors data-[popup-open]:bg-secondary"
            >
      ...
      <Dialog open={newPipelineOpen} onOpenChange={setNewPipelineOpen}>
        <DialogContent className="sm:max-w-sm bg-card border-border">
          ...
          <DialogFooter className="bg-surface-soft border-border">
            <Button
              variant="outline"

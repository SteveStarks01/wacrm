...
function MediaUnavailable({ label }: { label: string }) {
  return (
    <div className="flex items-center gap-2 rounded-lg bg-border/40 px-3 py-2 text-xs text-foreground">
...
function MediaImage({ url, alt }: { url: string; alt: string }) {
  ...
  if (error) {
    return (
      <div className="flex h-40 w-60 items-center justify-center rounded-lg bg-border">
    ...
    case "document":
      ...
      return (
        <a
          ...
          className="flex items-center gap-2 rounded-lg bg-border px-3 py-2 text-sm hover:bg-border"
        >
      ...
      >
        ...
        >
          <span
            className={cn(
              "text-[10px]",
              isAgent ? "text-primary-foreground/70" : "text-foreground/60",
            )}
          >
            {time}
          </span>

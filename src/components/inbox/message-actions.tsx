...
import { CornerUpLeft, Copy, SmilePlus } from "@/components/ui/icons";
    ...
    >
      ...
      >
        <Popover open={pickerOpen} onOpenChange={setPickerOpen}>
          <PopoverTrigger
            className="flex h-5 w-5 items-center justify-center rounded-full text-foreground hover:bg-border hover:text-foreground"
            aria-label="React"
          >
          ...
          >
            {QUICK_EMOJIS.map((e) => (
              <button
                ...
                className="flex h-8 w-8 items-center justify-center rounded-full text-lg leading-none transition-transform hover:scale-125 hover:bg-border"

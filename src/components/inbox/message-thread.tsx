 ...
 * `/public/inbox-doodle.svg`; the neutral surface sits underneath so
        ...
        <div className="flex min-w-0 items-center gap-2 sm:gap-3">
          ...
          {onBack && (
            <button
              ...
              className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-md text-foreground hover:bg-secondary hover:text-foreground lg:hidden"
            >
              <ArrowLeft className="h-5 w-5" />
            </button>
          )}
          <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-border text-sm font-medium text-foreground">
        ...
        <div className="flex items-center gap-2">
          ...
          {onRefresh && (
            <button
              ...
              title="Refresh"
              className={cn(
                "inline-flex h-7 w-7 items-center justify-center rounded-md text-muted-foreground transition-colors hover:bg-secondary hover:text-foreground disabled:opacity-60",
              )}
            >
              <RefreshCw

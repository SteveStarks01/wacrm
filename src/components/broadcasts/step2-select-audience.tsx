            ...
            <button
              ...
              className={`flex items-start gap-3 rounded-xl border p-4 text-left transition-all ${
                isSelected
                  ...
                  : 'border-border bg-surface-soft hover:border-border'
              }`}
            >
              <div
                  ...
                  <button
                    ...
                    className={`inline-flex items-center rounded-full border px-3 py-1 text-xs font-medium transition-all ${
                      isSelected
                        ...
                        : 'border-border bg-secondary text-foreground hover:border-border'
                    }`}
                  >
                    <span
          ...
          {loadingFields ? (
            ...
            <div className="grid grid-cols-1 gap-2 sm:grid-cols-[minmax(0,1fr)_140px_minmax(0,1fr)]">
              ...
              <input
                ...
                placeholder="Value"
                className="h-9 rounded-lg border border-border bg-secondary px-2.5 text-sm text-foreground outline-none placeholder:text-muted-foreground focus:border-primary focus:ring-1 focus:ring-primary"
              />
            </div>
          )}
        </div>

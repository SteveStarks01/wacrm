          ...
          <div className="flex-1 overflow-y-auto p-4 space-y-4">
            ...
            <div className="grid gap-2">
              ...
              <select
                ...
                className="h-9 w-full rounded-lg border border-border bg-secondary px-2.5 text-sm text-foreground outline-none focus:border-primary focus:ring-1 focus:ring-primary"
              >
              ...
              <div className="grid gap-2">
                ...
                <div className="relative">
                  ...
                  <Input
                    ...
                    placeholder="0"
                    className="border-border bg-secondary pl-7 text-foreground"
                  />
                </div>
              </div>
              <div className="grid gap-2">
                ...
                <div className="mt-3 flex items-center justify-between gap-2 rounded-md border border-red-500/30 bg-red-500/10 px-3 py-2 text-xs">
                  ...
                  <div className="flex gap-1">
                    <button
                      ...
                      disabled={deleting}
                      className="rounded px-2 py-1 text-foreground hover:bg-secondary"
                    >
                      Cancel
                    </button>
                    <button

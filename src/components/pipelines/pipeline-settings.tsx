      ...
      <DialogContent className="sm:max-w-md bg-card border-border max-h-[85vh] overflow-y-auto">
        ...
        {showDeleteConfirm ? (
          ...
          <>
            ...
            <DialogFooter className="border-border bg-surface-soft">
              <Button
                variant="destructive"
    ...
    <div className="relative">
      ...
      {open && (
        <>
          ...
          <div className="absolute left-0 top-6 z-20 flex flex-wrap gap-1 rounded-lg border border-border bg-card p-2 shadow-sm w-36">
            {colors.map((c) => (
              <button
                key={c}
                type="button"

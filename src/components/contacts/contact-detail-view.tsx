          ...
          <div className="flex flex-col h-full">
            ...
            <SheetHeader className="p-4 border-b border-border">
              <div className="flex items-center gap-3">
                <Avatar className="size-12 bg-secondary border border-border">
            ...
            <Tabs defaultValue="details" className="flex-1 flex flex-col min-h-0">
              <TabsList className="bg-secondary border-b border-border mx-4 mt-3">
                <TabsTrigger
                  value="details"
              ...
              <TabsContent value="notes" className="flex-1 flex flex-col min-h-0 px-4 py-3">
                <div className="space-y-2 mb-3">
                  <Textarea
                    ...
                    className="bg-secondary border-border text-foreground placeholder:text-muted-foreground min-h-[60px] text-sm resize-none"
                  />
                  <Button
                    onClick={addNote}
                ...
                <div className="flex-1 overflow-y-auto space-y-2">
                  {loadingNotes ? (
                    ...
                    notes.map((note) => (
                      <div
                        key={note.id}
                        className="rounded-lg bg-secondary border border-border p-3 group"
                      >
                    ...
                    {customFields.map((field) => (
                      <div key={field.id} className="space-y-1.5">
                        ...
                        <Input
                          ...
                          className="bg-secondary border-border text-foreground h-8 text-sm placeholder:text-muted-foreground"
                        />
                      </div>
                    ))}
                    <Button
